package com.yuezhi.ws.http.shiro;
...
public class MyShiroFilterFactoryBean extends ShiroFilterFactoryBean {
    ...
    public static String filterChainDefinitions = "";//记录配置中的过滤链，这个要和配置文件中的名称要一样
    ...
    public void setFilterChainDefinitions(String definitions) {
        ...
        //logger.info("资源权限如下："+hasRoleCodeMap);
        Ini ini = new Ini();
