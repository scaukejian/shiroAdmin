...
(function() {
	...
	var util = window.bestMeet.util;
	var UI = window.bestMeet.ui;
    ...
    UI.msgBox = function(para) {
		...
		var getHtml = function() {
			...
			//headHtml.append('<span><a  id="').append(p.id).append('_close"  href="javascript:void(0);"><img src="'+rootPath+'/images/bestMeet/close.png" border="0"></a></span>').append(p.title);
			//headHtml.append('<div class="title"><a style="text-align: right" id="').append(p.id).append('_close"  href="javascript:void(0);"><img src="'+rootPath+'/images/bestMeet/close.png" border="0"></a>').append(p.title).append("</div>");
