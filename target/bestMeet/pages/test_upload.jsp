...
<body>
 	 ...
 	 <h2>用户资料上传</h2>
 	<form name="userForm" action="/bestMeet-ws/userDatum/upload.do" enctype="multipart/form-data" method="post">
 		<div id="newUpload">
     ...
     <form name="download" action="/bestMeet-ws/userDatum/download.do" method="post">
     ...
     <h1></h1>
     <h2>用户头像上传</h2>
     <form name="userForm" action="/bestMeet-ws/user/upload.do" enctype="multipart/form-data" method="post">
         <div>
     ...
     <h1></h1>
     <h2>相册上传</h2>
     <form name="photoForm" action="/bestMeet-ws/photo/upload.do" enctype="multipart/form-data" method="post">
         <div>
             <input type="file" name="files">
         </div>
         <input type="hidden" name="userId" value="2">
     ...
     <form name="download" action="/bestMeet-ws/photo/delete.do" method="post">
